...
const statusConfig = {
  ...
  ui_test_success:  { color: uiPalette.success,  icon: <CheckCircleFilled />,      label: '通过' },
  ui_test_failed:   { color: uiPalette.error,    icon: <CloseCircleFilled />,      label: '不通过' },
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 8 }}>
              <Space size={8} wrap>
                ...
                {step?.result_payload?.action_meta?.used_ai ? <Tag color="gold">AI</Tag> : null}
              </Space>
              <Space size={8}>
